...
| Icon | Name | Description |
| --- | --- | --- |
| <img src="https://raw.githubusercontent.com/danitesler/playnite-extensions/main/src/ShadcnUiTheme/info/icon.png" alt="Shadcn UI Theme" width="80" height="80" /> | **Shadcn UI Theme** (`shadcnuitheme`) | A fully dark desktop theme in the style of [shadcn/ui](https://ui.shadcn.com).<br><br>• shadcn's inset dashboard: the library on a rounded card inside a zinc frame, no divider lines<br>• lucide icons, borderless buttons, shadcn inputs, tabs, menus, and sliders |
| <img src="https://raw.githubusercontent.com/danitesler/playnite-extensions/main/src/ChakraUiTheme/info/icon.png" alt="Chakra UI Theme" width="80" height="80" /> | **Chakra UI Theme** (`chakrauitheme`) | A fully dark desktop theme in the style of [Chakra UI](https://chakra-ui.com).<br><br>• One flat surface with Chakra's teal accent; view controls in a segmented group, a roomy 64px top bar<br>• Borderless buttons and inputs, underline tabs, Chakra's slider and 2px focus ring |
| <img src="https://raw.githubusercontent.com/danitesler/playnite-extensions/main/src/MaterialUiTheme/info/icon.png" alt="Material UI Theme" width="80" height="80" /> | **Material UI Theme** (`materialuitheme`) | A fully dark desktop theme in the style of [Material UI](https://mui.com/material-ui/).<br><br>• An elevated app bar across the window, a mini drawer, round icon buttons with Material icons<br>• Uppercase text and contained buttons, filled inputs, Material checkboxes, radios, and sliders |
| <img src="https://raw.githubusercontent.com/danitesler/playnite-extensions/main/src/PrimerTheme/info/icon.png" alt="Primer Theme" width="80" height="80" /> | **Primer Theme** (`primertheme`) | A fully dark desktop theme in the style of GitHub's [Primer](https://primer.style) design system.<br><br>• GitHub's layout: a dark header band with search and Octicons on the right, NavList sidebar<br>• GitHub dark colors, green primary buttons, underline tabs with the coral active bar |
| <img src="https://raw.githubusercontent.com/danitesler/playnite-extensions/main/src/Fluent2Theme/info/icon.png" alt="Fluent 2 Theme" width="80" height="80" /> | **Fluent 2 Theme** (`fluent2theme`) | A fully dark desktop theme in the style of Microsoft's [Fluent 2](https://fluent2.microsoft.design) design system.<br><br>• Windows 11 layout: a compact navigation rail, a title bar with centered search, the library on a content layer<br>• Fluent icons, underline inputs with an animated focus line, Fluent tabs, checkboxes, radios, and sliders |
